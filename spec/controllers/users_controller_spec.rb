...
#         post :create, user: { username: "test_user", email: "test_user@user.com", password: "password" }
#         expect(user).to be_a(User)
#       end

#       it "assigns a new user as @user" do
#         post :create, user: { username: "user1", email: "test_user1@user.com", password: "password" }
